...
- Proofs refine a baseline schema with `refineType` for semantic guards.
...
Domain operations on shapes or primitives in `operations/`, generated by the `capabilities` generator.
